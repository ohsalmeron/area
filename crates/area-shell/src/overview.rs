...
fn render_overview(
    ...
    commands
        .spawn((
            ...
            BackgroundColor(Color::srgba(0.0, 0.0, 0.0, 0.0)), // Start transparent
            crate::animation::UiAnimation {
            ...
            for window in state.windows.values() {
                ...
                parent
                    .spawn((
                        ...
                        WindowTile(window.id),
                        NeedsThumbnail, // Mark for fetching
                        crate::animation::UiAnimation {
...
fn fetch_thumbnails(
    ...
    grabber: Res<crate::grab::X11Grabber>,
