...
impl FocusManager {
    ...
    pub fn set_focus(
        ...
        // Set X11 focus
        conn.set_input_focus(InputFocus::POINTER_ROOT, client.window, x11rb::CURRENT_TIME)?;
        ...
        display_info
            .atoms
            .update_active_window(conn, screen_info.root, Some(client.window))?;
    ...
    pub fn remove_focus(
        ...
        if self.focused_window == Some(window) {
            ...
            display_info
                .atoms
                .update_active_window(conn, screen_info.root, None)?;
    ...
    pub fn handle_net_active_window(
        ...
        debug!(
            "_NET_ACTIVE_WINDOW request for window {} (source={:?})",
            window, source
        );
